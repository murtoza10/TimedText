...
public class PendingIntentSQLiteHelper extends SQLiteOpenHelper {
  ...
  public static String TABLE_PENDINGINTENT = "pendingintents";
  public static String TABLE_PENDINGINTENT1 = "pendingintents1";
 ...
 private static final String DATABASE_CREATE1 = "create table " + TABLE_PENDINGINTENT1 + "(" + COLUMN_ID + " integer primary key , " + COLUMN_HOUR +" integer, " + COLUMN_MINUTES + " integer, " + COLUMN_SECONDS + " integer, " + COLUMN_YEAR + " integer, " + COLUMN_MONTH + " integer, " + COLUMN_DAY + " integer, " + COLUMN_FREQUENCY + " String, " + COLUMN_NUMBERTOSEND + " String, " + COLUMN_RECEIVERNAME + " String, " + COLUMN_MESSAGE + " String " + ");";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		db.execSQL("DROP TABLE IF EXISTS " + TABLE_PENDINGINTENT1);
	    onCreate(db);
	}
