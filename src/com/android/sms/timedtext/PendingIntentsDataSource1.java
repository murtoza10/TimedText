...
public class PendingIntentsDataSource1 {

	  private SQLiteDatabase database;
	  private PendingIntentSQLiteHelper1 dbHelper;
	  private String[] allColumns = { PendingIntentSQLiteHelper1.COLUMN_ID,PendingIntentSQLiteHelper1.COLUMN_HOUR, PendingIntentSQLiteHelper1.COLUMN_MINUTES, PendingIntentSQLiteHelper1.COLUMN_SECONDS, PendingIntentSQLiteHelper1.COLUMN_YEAR, PendingIntentSQLiteHelper1.COLUMN_MONTH, PendingIntentSQLiteHelper1.COLUMN_DAY, PendingIntentSQLiteHelper1.COLUMN_FREQUENCY, PendingIntentSQLiteHelper1.COLUMN_NUMBERTOSEND, PendingIntentSQLiteHelper1.COLUMN_RECEIVERNAME, PendingIntentSQLiteHelper1.COLUMN_MESSAGE };
	  private int mYear;
		private int mMonth;
		private int mDay;
	    ...
	    private int mId;
	    Calendar c,d;
	  public PendingIntentsDataSource1(Context context){
		  dbHelper = new PendingIntentSQLiteHelper1(context, "pendingintents.db",null, 2);
	  }
	  ...
	  public SMSSchedulerPendingIntent createPendingIntents(String tb_name,int id, int hour, int mins, int secs, int year, int month, int day, String frequency, String number, String name, String message){
		  ...
		  values.put(PendingIntentSQLiteHelper1.COLUMN_ID, id);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_HOUR, hour);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_MINUTES, mins);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_SECONDS, secs);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_YEAR, year);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_MONTH, month);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_DAY, day);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_FREQUENCY, frequency);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_NUMBERTOSEND, number);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_RECEIVERNAME, name);
		  values.put(PendingIntentSQLiteHelper1.COLUMN_MESSAGE, message);
		  ...
		  Cursor cursor = database.query(tb_name,
			        allColumns, PendingIntentSQLiteHelper1.COLUMN_ID + " = " + id, null,
			        null, null, null);
	  ...
	  public void deletePendingIntent(String tb_name,int id) 
		{
		  System.out.println("hmm");
		      database.delete(tb_name, PendingIntentSQLiteHelper1.COLUMN_ID + "=" + id, null);
		      System.out.println("hmm");
		      return;
		}
}
